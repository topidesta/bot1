...
const MYSQL_DB_PASSWORD = "toor";
const MYSQL_DB_NAME = "abc-system";
...
const flowDukunganKomersil = addKeyword([
  "Atención",
  "atención",
  "PERHATIAN",
  "Perhatian",
...
const flowDukunganTeknik = addKeyword([
  "Soporte Técnico",
  "Dukungan",
  "support",
  "Teknik",
...
const flowEscrito = addKeyword(["PPPP", "Pppp", "pppp"]).addAnswer(
  [
    "*Temukan Kebutuhan mu disini 👇*",
    "Untuk mengakses layanan, tulis *nama*",
    "",
    "Untuk mengakses ketik *Menu*",
    "👉 Jasa",
    "",
    "Untuk mengakses ketik *Dukungan*",
    "👉 Dukungan Teknis",
    "",
    "Untuk mengakses tulis *Perhatian*",
    "👉 Perhatian Komersial",
    "",
    "Untuk mengakses jenis *Produk*",
    "👉 Produk",
    "",
    "Untuk mengakses jenis *Analisis*",
    "👉 Untuk mengakses jenis *Analisis*",
  ],
  null,
  null,
